...
from electroncash_gui.qt.util import ThreadedButton, Buttons, EnterButton, WindowModalDialog, OkButton
...
class Plugin(LabelsPlugin):
    ...
    def done_processing_error(self, dialog, exc_info):
        _logger.error("Error synchronising labels", exc_info=exc_info)
